...
wlink system os2 path ~/ow/open-watcom-v2/rel/lib286:~/ow/open-watcom-v2/lib286/os2 library ~/ow/open-watcom-v2/lib286/os2/os2.lib name test.exe file "$PWD/test.o"
